...
function getTime() {
    ...
    var dateTime = codeMonth + "" + codeDay + "" + codeYear + "." + codeHour + "" + codeMinute;
...
var theDay = new Array("Zero", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday")
var theDayMin3 = new Array("Zero", "Sun.", "Mon.", "Tues.", "Wed.", "Thurs.", "Fri.", "Sat.")
var theDayMin2 = new Array("Zero", "S", "M", "Tu", "W", "Th", "F", "S")
var theDayMin1 = new Array("Zero", "S", "M", "T", "W", "T", "F", "S")
var theMonth = new Array("Zero", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December")
var theMonthMin = new Array("Zero", "Jan.", "Feb.", "Mar.", "Apr.", "May", "June", "July", "Aug.", "Sept.", "Oct.", "Nov.", "Dec.")
